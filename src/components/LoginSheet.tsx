    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <motion.div
            className="sheet-chrome relative z-[1] mt-auto shrink-0 bg-white/98 px-5 pb-[calc(env(safe-area-inset-bottom)+1.5rem)] pt-3 shadow-[0_-20px_60px_-10px_rgba(0,0,0,0.22)] backdrop-blur-2xl"
            initial={{ y: "100%" }}
            animate={{ y: 0 }}
            exit={{ y: "100%" }}
