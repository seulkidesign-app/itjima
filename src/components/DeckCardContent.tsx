  ...
  return (
    <>
      {item.images?.length > 0 && (
        <div className="deck-card-images mb-4 flex gap-2 overflow-x-auto">
      ...
      <div className="deck-card-thought select-text">
        <p
      ...
      {showNlMirror && (
        <div
          className="deck-mirror-panel mt-5 border-t border-ink/[0.07] pt-4"
          role="complementary"
