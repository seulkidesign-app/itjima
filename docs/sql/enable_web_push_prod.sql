...
-- ---------------------------------------------------------------------------
-- 5. Account-safe register/revoke RPCs
-- ---------------------------------------------------------------------------
...
BEGIN
  ...
  INSERT INTO public.push_subscriptions (
    user_id, endpoint, p256dh, auth, platform, revoked_at, failure_count, updated_at
  )
  VALUES (
    v_user_id, p_endpoint, p_p256dh, p_auth, p_platform, NULL, 0, now()
  )
